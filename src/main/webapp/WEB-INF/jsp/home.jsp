...
<head>
    ...
    <style>
        ...
        /* Tiêu đề "Phim Đang Chiếu" với hiệu ứng khung chiếu phim */
        .title-container {
            position: relative;
            margin-top: 30px;
            margin-bottom: 30px;
        ...
        .frame-left, .frame-right {
            ...
            top: 0;
            height: 100%;
            background: linear-gradient(45deg, #f1c40f, #f39c12); /* Màu sáng giống đèn cinema */
            width: 15%;
            z-index: 0;
        }
        ...
        .light-left:before, .light-right:before {
            content: '';
            position: absolute;
            top: -5px;
            left: 50%;
        ...
        /* Tiêu đề "Chọn Phim" với hiệu ứng thư viện phim */
...
<div class="container">
    ...
    <div class="text-center title-container">
        <h1 class="cinema-title">
            <span class="frame-left"></span> <!-- Khung chiếu bên trái -->
            <span class="title-text">Phim Đang Chiếu</span>
            <span class="frame-right"></span> <!-- Khung chiếu bên phải -->
        </h1>
        ...
        <div class = 'search-box d-flex justify-content-between'>
            <div class="text-center choose-movie-container">
                <h1 class="choose-movie-title">
                    ...
                    <span class="title-text">Chọn Phim</span>
                    <span class="select-icon"></span> <!-- Biểu tượng chọn phim -->
                </h1>
