            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="widget subscribe no-box">
                        <h5 class="widget-title">CINEMA - The Martian<span></span></h5>
                        <p>Uy Tin Lam Nen Thuong Hieu</p>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                    ...
                    <div class="widget no-box">
                        ...
                        <p>Tru so chinh: Linh Trung, Thu Duc</p>
                        <p>SDT: 096 659 5038</p>
                        <p>Lien he voi Doi ngu qua Gmail: <a href="https://mail.google.com/mail/u/0/#inbox?compose=GTvVlcRzDshFpbThCDXJxQnhtmLnDkLnzzrGdPjPjNphcwWMfBLPzsjrtqDnLkZBlDLmttgvKxjNs" title="glorythemes">Nguyenhuuphong2k3@gmail.com</a></p>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4">
                                    <div class="widget subscribe no-box">
                                        <h5 class="widget-title">Map<span></span></h5>
                                        <p><img src="https://cdn.vietnammoi.vn/171464242508312576/2021/8/1/picture1-1627801951767973073148-0-180-560-1020-crop-16278022905331967370461.png" style="width: 300px; height: 150px;"</p>
                                    </div>
                                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <p>@Copyright CINEMA 2024. All rights reserved</p>
                    <p>Designed by The Martian Team</p>
                </div>
            </div>
        </div>
    </div>
