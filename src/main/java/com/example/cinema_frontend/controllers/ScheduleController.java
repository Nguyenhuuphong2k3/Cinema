...
import com.example.cinema_frontend.models.JwtResponseDTO;
...
public class ScheduleController {
    ...
    public String displaySchedulePage(@RequestParam Integer movieId,@RequestParam Integer branchId, Model model, HttpServletRequest request){
        ...
        LocalDate today = LocalDate.parse("2024-11-20");
        ...
        listRequestParam.put("startDate",LocalDate.parse("2024-11-20").format(DateTimeFormatter.ofPattern("yyyy-MM-dd")));
